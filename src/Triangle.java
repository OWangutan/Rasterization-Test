...
public class Triangle{
    ...
    public Triangle unShift(Point3D position){
        return new Triangle(Point3D.unTranslate(pointA,position),Point3D.unTranslate(pointB,position),Point3D.unTranslate(pointC,position),color);
    }
